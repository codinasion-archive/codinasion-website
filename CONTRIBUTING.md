# Welcome to Codinasion Website contributing guide
...
If you want to add or modify content, [search if an issue already exists](https://github.com/codinasion/codinasion-website/issues). If a related issue doesn't exist, you can open a new issue using a relevant [issue template](https://github.com/codinasion/codinasion-website/issues/new/choose).
...
```
git clone https://github.com/your_username/codinasion-website
```
